...
<head>
    ...
    <title>Indigenous Knowledge Admin Dashboard</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0;">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/"><i>Indigenous Knowledge</i></a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa fa-folder-open-o fa-fw"></i> Categories<span class="fa arrow"></span></a>
                        ...
                        <li>
                            <a href="#"><i class="fa fa fa-folder-open-o fa-fw"></i> Articles <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="view_users.html">View User</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                       ...
                       <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="morris.html">Edit Profile</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
