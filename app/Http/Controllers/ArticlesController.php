...
class ArticlesController extends Controller
{
    ...
    function update($id){
       ...
       $article = Article::where('article_id', '=', $id)->update(['title'=>$_POST['title'], 'body' => $_POST['body'], 'cat_id' => $_POST['category'],'image_url' => $_POST['image'],'video_url' => $_POST['video'], 'editor_id' => $_POST['editor']]);
